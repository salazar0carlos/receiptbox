...
interface CardProps extends HTMLAttributes<HTMLDivElement> {
  children: ReactNode;
  className?: string;
  variant?: 'default' | 'bordered' | 'shadow' | 'glass' | 'glass-strong';
...
export default function Card({
  ...
  const variantStyles = {
    ...
    glass: 'glass hover:bg-white/15 transition-all duration-300',
    'glass-strong': 'glass-strong hover:bg-white/20 transition-all duration-300',
  };
